    ...
    try:
        ...
        for model in models:
            ...
            if hasattr(model, "model"):
                ...
                model_name = (
                    model.get("model") or model.get("name") or model.get("model_name")
                )
            ...
            try:
                ...
                if api_response.status_code == 200:
                    ...
                    if "models" in api_data:
                        api_models = [
                            m.get("name", "unknown") for m in api_data["models"]
                        ]
                        if api_models:
        ...
        try:
            ...
            print("   Error occurred (details unavailable due to encoding)")
        return None
